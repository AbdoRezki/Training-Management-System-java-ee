...
<input type="hidden" name="command" value="ADD" />
  		...
  		<div class="col-sm-10">
    		<input type="text" class="form-control" id="staticEmail" name="theme" placeholder="Theme de la formation">
  		</div>
	</div>
	<div class="form-group row" style="margin-top:2%">
  		<label for="staticEmail" class="col-sm-2 col-form-label">idlieu</label>
  		<div class="col-sm-10">
    		<input type="text" class="form-control" id="staticEmail" name="idlieu" placeholder="idlieu">
  		</div>
	</div>
